...
class SA_RIBBON_EXPORT SARibbonMainWindow : public QMainWindow
{
  ...
  public:
    explicit SARibbonMainWindow(
      ...
      SARibbonMainWindowStyles style = { static_cast< int >( SARibbonMainWindowStyleFlag::UseRibbonMenuBar ) | static_cast< int >( SARibbonMainWindowStyleFlag::UseRibbonFrame ) },
